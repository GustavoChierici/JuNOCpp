...
namespace JuNOCpp
{
    ...
    namespace Attributes
    {
        ...
        public:
            Attribute(CustomString name = "UnnamedAttribute");
            Attribute(TYPE value, CustomString name = "UnnamedAttribute");
         ...
         */
        template<class TYPE>
        Attribute<TYPE>::Attribute(CustomString name):
        Notifiable(name)
        {
         ...
         */
        template<class TYPE>
        Attribute<TYPE>::Attribute(TYPE value, CustomString name):
        Notifiable(name)
        {
        ...
        // template <class TYPE>
        // Attribute<TYPE> Attribute<TYPE>::operator+(Attribute<TYPE>& b_attr)
        // {
        //     Attribute<TYPE> aux;

        //     this->referenceAttributeAbove(&aux);
        //     b_attr.referenceAttributeAbove(&aux);
